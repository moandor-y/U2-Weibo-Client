...
public class UrlHelper {
    ...
    public static final String STATUSES_QUERYID = "https://api.weibo.com/2/statuses/queryid.json";
    ...
    static final String WEIBO_CN = "http://weibo.cn";
    static final String WEIBO_COM = "http://weibo.com";
