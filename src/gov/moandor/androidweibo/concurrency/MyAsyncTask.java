 ...
 * pacakge such as {@link Executor}, {@link ThreadPoolExecutor} and {@link FutureTask}.
 * </p>
 * 
 * <p>
 ...
 * </p>
 * <ol>
 * <li>{@link #onPreExecute()}, invoked on the UI thread before the task is executed. This step is
 * normally used to setup the task, for instance by showing a progress bar in the user interface.</li>
 ...
 * with {@link android.os.Build.VERSION_CODES#DONUT}, this was changed to a pool of threads allowing
 * multiple tasks to operate in parallel. Starting with
 * {@link android.os.Build.VERSION_CODES#HONEYCOMB}, tasks are executed on a single thread to avoid
...
public abstract class MyAsyncTask<Params, Progress, Result> {
    ...
    private static final int DOWNLOAD_CORE_POOL_SIZE = 4;
    ...
    private static final BlockingQueue<Runnable> sDownloadPoolWorkQueue = new LinkedBlockingQueue<Runnable>(5);
     ...
     *             If {@link #getStatus()} returns either {@link MyAsyncTask.Status#RUNNING} or
     *             {@link MyAsyncTask.Status#FINISHED}.
     * 
